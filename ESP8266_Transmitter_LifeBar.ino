...
void OnDataRecv(uint8_t *mac, uint8_t *incomingData, uint8_t len) {
  ...
  memcpy(&Lives, incomingData, sizeof(Lives));

  Serial.print("Lives received: ");
  Serial.println(Lives.lives);
    updateHealthBar();   // <-- ADD THIS
...
void updateHealthBar() {
  ...
  if(lives >= 3) {
    ...
    // 3 yellow LEDs
    leds[0] = CHSV(40,255,180);  ;
    leds[1] = CHSV(40,255,180) ;
    leds[2] = CHSV(40,255,180);
  }
